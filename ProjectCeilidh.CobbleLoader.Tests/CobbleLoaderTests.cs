...
namespace ProjectCeilidh.CobbleLoader.Tests
{
    ...
    loader=""dotnet""
    update=""https://gihub.com/owner/project/manifest.xml"">
    ...
    <files>
        ...
        public async void CobbleLoaderTest()
        {
            ...
            Assert.True(await loader.TryInstallAsync(
                new Uri("base64:" + Convert.ToBase64String(Encoding.ASCII.GetBytes(MANIFEST_XML)))));
            Assert.Single(loader.EnumerateInstalledPlugins());
            Assert.True(File.Exists(Path.Combine(loader.PluginStorageDirectory, "test-package", "README")));
